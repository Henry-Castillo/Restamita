...
public class PantallaDelAdmin extends javax.swing.JFrame {

    public PantallaDelAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaDelAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaDelAdmin().setVisible(true);
            }
        });
    }
